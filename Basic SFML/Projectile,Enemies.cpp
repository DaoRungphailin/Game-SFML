...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        for (size_t i = 0; i < projectiles.size(); i++)
        {
            ...
            if (projectiles[i].getPosition().y <= 10)//if projectiles out screen remove it
            {
        ...
        for (size_t i = 0; i < enemies.size(); i++)
        {
            ...
            if (enemies[i].getPosition().y > window.getSize().y)//if enemies out screen remove it
            ...
            for (size_t i = 0; i < projectiles.size(); i++)
            {
                for (size_t k = 0; k < enemies.size(); k++)
                {
                    if (projectiles[i].getGlobalBounds().intersects(enemies[k].getGlobalBounds()))
                    {
                        ...
                        break;//if hit break and go again
                    }
                }
            }
        }
